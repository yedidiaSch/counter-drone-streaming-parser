...
A convenience script builds the project, starts the server, runs the load test with 100 drones, and shuts everything down cleanly:

```bash
./run_test.sh
```

Only the Python dashboard output is shown in the terminal.
